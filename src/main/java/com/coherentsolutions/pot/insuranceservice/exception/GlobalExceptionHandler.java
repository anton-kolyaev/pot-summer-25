...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @SafeVarargs
  private static Map<String, Object> buildDetails(HttpServletRequest req,
      Map.Entry<String, Object>... extras) {
  ...
  /**
   * Handles any unexpected exceptions not explicitly caught by other handlers.
   */
