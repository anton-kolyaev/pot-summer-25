...
/**
 * Service class for managing {@link User} entities including retrieval with filtering,
...
public class UserManagementService {
  ...
  /**
   * Retrieves a paginated list of users filtered by criteria
   * specified in {@link UserFilter}.
   */
   ...
   * Synchronizes the user's function assignments with the incoming data.
   */
