...
class AdminUserManagementControllerTest {
  ...
  @InjectMocks private AdminUserManagementController controller;
  ...
  /*
   * Test for getting user details by ID.
   * This test verifies that the controller correctly retrieves user details
   */
  @Test
  ...
  void shouldGetUserDetailsById() throws Exception {
    ...
    // When & Then
    mockMvc
        .perform(get("/v1/users/{id}", testUserId).contentType(MediaType.APPLICATION_JSON))
