...
class CompanyManagementServiceTest {
  ...
  void shouldThrowExceptionWhenCompanyNotFound() {
    // Given
    when(companyRepository.findByIdOrThrow(testCompanyId))
        .thenThrow(new ResponseStatusException(HttpStatus.NOT_FOUND, "Company not found"));
  ...
  void shouldThrowExceptionWhenUpdatingNonExistentCompany() {
    // Given
    CompanyDto updateRequest = CompanyDto.builder().name("Updated Company").build();
